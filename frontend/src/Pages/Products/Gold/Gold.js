          ...
          <div className="container">
            <div className="row">
              <div style={{ height: 800 }} className="col-3 catagory-container">
                ...
                <div onClick={() => setCategory("Anklet")} >
                  <NavLink>       <img src={anklet} width="100px" alt="" />
                    <p className="catagory-text">Anklet</p>
                  </NavLink>
                </div>
                <div onClick={() => setCategory("Bala")} >
                  <NavLink >       <img src={bala} width="100px" alt="" />
                    <p className="catagory-text">Bala</p>
                  </NavLink>
                </div>
                <div onClick={() => setCategory("Bangal")} >
                  <NavLink style={{ marginBottom: 0 }}>       <img src={bangle} width="100px" alt="" />
                    <p className="catagory-text">Bangle</p>
                  </NavLink>
                </div>
                <div onClick={() => setCategory("Crown")} >
                  <NavLink style={{ marginBottom: 0 }}>       <img src={crown} width="100px" alt="" />
                    <p className="catagory-text">Crown</p>
                  </NavLink>
                </div>

                <div onClick={() => setCategory("Chur")} >
                  <NavLink style={{ marginBottom: 0 }}>       <img src={chur} width="100px" alt="" />
                    <p className="catagory-text">Chur</p>
                  </NavLink>
                </div>

                <div onClick={() => setCategory("Chain")} >
                  <NavLink style={{ marginBottom: 0 }}>       <img src={chain} width="100px" alt="" />
                    <p className="catagory-text">Chain</p>
                  </NavLink>
                </div>
                <div onClick={() => setCategory("Earrings")} >
                  <NavLink style={{ marginBottom: 0 }}>       <img src={earring} width="100px" alt="" />
                    <p className="catagory-text">Ear Ring</p>
                  </NavLink>
                </div>
                <div onClick={() => setCategory("Finger Ring")} >
                  <NavLink style={{ marginBottom: 0 }}>       <img src={fingerring} width="100px" alt="" />
                    <p className="catagory-text">Finger Ring</p>
                  </NavLink>
                </div>
                <div onClick={() => setCategory("Locket")} >
                  <NavLink style={{ marginBottom: 0 }}>       <img src={locket} width="100px" alt="" />
                    <p className="catagory-text">Locket</p>
                  </NavLink>
                </div>
                <div onClick={() => setCategory("Mangalsutra")} >
                  <NavLink style={{ marginBottom: 0 }}>       <img src={mongalsuttra} width="100px" alt="" />
                    <p className="catagory-text">Mangalsutra</p>
                  </NavLink>
                </div>
                <div onClick={() => setCategory("Necklace")} >
                  <NavLink style={{ marginBottom: 0 }}>       <img src={necklace} width="100px" alt="" />
                    <p className="catagory-text">Necklace</p>
                  </NavLink>
                </div>
                <div onClick={() => setCategory("Nosepin")} >
                  <NavLink style={{ marginBottom: 0 }}>       <img src={nosepin} width="100px" alt="" />
                    <p className="catagory-text">Nosepin</p>
                  </NavLink>
                </div>
                <div onClick={() => setCategory("Pola")} >
                  <NavLink style={{ marginBottom: 0 }}>       <img src={pola} width="100px" alt="" />
                    <p className="catagory-text">Pola</p>
                  </NavLink>
                </div>
                <div onClick={() => setCategory("Shakha")} >
                  <NavLink style={{ marginBottom: 0 }}>       <img src={shakha} width="100px" alt="" />
                    <p className="catagory-text">Shakha</p>
                  </NavLink>
                </div>
                <div onClick={() => setCategory("Shitahar")} >
                  <NavLink style={{ marginBottom: 0 }}>       <img src={sitahar} width="100px" alt="" />
                    <p className="catagory-text">Shitahar</p>
                  </NavLink>
                </div>
                <div onClick={() => setCategory("Tiara")} >
                  <NavLink style={{ marginBottom: 0 }}>       <img src={tiara} width="100px" alt="" />
                    <p className="catagory-text">Tiara</p>
                  </NavLink>
                </div>
                <div onClick={() => setCategory("Tikli")} >
                  <NavLink style={{ marginBottom: 0 }}>       <img src={tikli} width="100px" alt="" />
                    <p className="catagory-text">Tikli</p>
                  </NavLink>
                </div>
                <div onClick={() => setCategory("Others")} >
                  <NavLink style={{ marginBottom: 0 }}>       <img src={others} width="100px" alt="" />
